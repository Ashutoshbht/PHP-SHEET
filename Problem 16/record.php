...
<table>
    ...
    <?php
    // to display all record of formtable query will be used
    $query="select * from formtable";
    // dtaabase connectivity 
    ...
    while($row=mysqli_fetch_array($result)){ 
        ...
        // the <a> will used to display delete update icon in the table
        echo "<th>
        <a href='delete.php?'><span class='material-icons'>".$icons[0]."</span></a>
        <span class='material-icons'>".$icons[1]."</span>
        </th>";
        echo"</tr>";
    }
